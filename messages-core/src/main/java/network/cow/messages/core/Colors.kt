package network.cow.messages.core
...
object Colors {
    ...
    @JvmField val INFO = Color(150, 150, 150) // #969696
    ...
    @JvmField val DEBUG = Color(252, 6, 245) // #FC06F5

    @JvmField val ACTIVE = Color(34, 197, 94) // #22C55E
    @JvmField val INACTIVE = Color(185, 28, 28) // #B91C1C
